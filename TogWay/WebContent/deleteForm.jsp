      ...
      <div class="container-fluid">
		...
		<div id="content">
			<div class="main" align="center">
				...
				<form action="delete.do" id="form-box" method="post" name="frm">
					<div class="icon">
						<span class="fa fa-user"></span>
					</div>
					<div class="input">
						<input type="text" name="userid" value="${userid}" class="inp" disabled>	
					</div>
					...
					<div class="input">
						<input type="password" name="passwd" placeholder="비밀번호 입력" class="inp" autofocus required>
					</div>
					
					<div class="up-btn" style="margin-bottom: 10px;">
						<input type="submit" value="회원 탈퇴" class="data-btn">
						<input type="reset" value="취소" onclick="location.href='memberdata.do'" class="data-btn">
					</div>
					</form>
				</div>
			</div>
