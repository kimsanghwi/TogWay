		...
		<div id="content">
			<div class="main" align="center">
				<header>
					...
					<div class="heading">마이 정보 보기</div>
				</header>
				
				<form action="memberdata.do" id="form-box" method="post" name="frm">
					<div class="icon">
					...
					<div class="input">	
						<input type="text" name="tel" value="${vo.tel }" class="inp" disabled>
					</div>
					...
					<div class="input">
						<input type="email" name="email" value="${vo.email }" class="inp" disabled>
					</div>
					
					<div class="up-btn" style="margin-bottom: 10px;">
						<input type="submit" value="정보수정" onclick="location.href='memberUpdate.do'" class="data-btn">
						<input type="submit" value="탈퇴" onclick="location.href='delete.do'" class="data-btn">
					</div>
					<div class="under-btn">
						<input type="submit" value="비밀번호 변경" onclick="location.href='newpasswd.do'" class="data-btn">
						<input type="submit" value="취소" onclick="location.href='login.do'" class="data-btn"><!-- 메인게시판으로 연결 해야됨 -->
					</div>
