...
import togwayDB.TogWaySearchDBBean;

public class Board_Search_List_Action implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TogWaySearchDBBean togbean = TogWaySearchDBBean.getinstance();	
		
		count = togbean.SearchgetAllCount(search);
		...
		List<TogWayBoardDataBean> selist = togbean.selectAllSearchBoards(search, startRow, endRow);
		...
		request.setAttribute("togbean", selist);
		...
		request.setAttribute("currentPage", currentPage);
			...
			request.getRequestDispatcher("search_board.jsp").forward(request, response);
